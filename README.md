...
| <a name="input_policy_revision"></a> [policy\_revision](#input\_policy\_revision) | Optional content hash for the policy set; changes create a Cloud Run revision after policy upload. | `string` | `null` | no |
